            ...
            <div>
                <div class="product-thumb transition maxheight1">
                    <div class="quick_info">
                        <div id="quickview_latest_<?php echo $f?>" class="quickview-style">
                            <div>
                    ...
                    <div class="cart-button">
                        ...
                        <a class="quickview quickview-latest btn" data-toggle="tooltip"
                           title="<?php echo $text_quick; ?>" rel="group" href="#quickview_latest_<?php echo $f?>">
