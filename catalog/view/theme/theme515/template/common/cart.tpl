...
<div id="cart" class="cart">
	<button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="dropdown-toggle">
		...
		<?php if (isset($text_items2)) { ?><span id="cart-total2" class="cart-total2 visible-xs"><?php echo $text_items2; ?></span><?php } ?>
		<?php if (isset($text_items3)) { ?><span id="cart-total3" class="cart-total3 hidden-xs"><?php echo $text_items3; ?></span><?php } ?>
